...
class TaskRepository(BaseRepository[Task, TaskCreate, TaskUpdate]):
  ...
  def get_by_user(self, session: Session, user_id: int) -> List[Task]:
  ...
  def mark_completed(self, session: Session, task_id: int) -> Optional[Task]:
  ...
  def mark_in_progress(self, session: Session, task_id: int) -> Optional[Task]:
